...
def process_data(data):
  ...
  for item in data:
    ...
    if item_revenue > max_revenue["revenue"]:
      ...
      max_revenue = item
    #Find car with most sales
    if sales < item["total_sales"]:
        sales = item["total_sales"]
        max_sales = item
    #Find most popular car year
    if not item["car"]["car_year"] in best_car.keys():
            best_car[item["car"]["car_year"]] = item["total_sales"]
    else:
            best_car[item["car"]["car_year"]] += item["total_sales"]

    #Returns a list with the values from the best_car dictionary
...
def main(argv):
  ...
  data = load_data("/home/student-04-38da34f536ae/car_sales.json")
  ...
  msg = email_generate("automation@example.com", "student-04-38da34f536ae@example.com",
